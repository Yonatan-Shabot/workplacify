  ...
  return (
    <>
      ...
      <List.Root
        ...
        marginTop="0.6rem"
      >
        <List.Item>What data do we collect?</List.Item>
        <List.Item>How do we collect your data?</List.Item>
        <List.Item>How will we use your data?</List.Item>
        <List.Item>How do we store your data?</List.Item>
        <List.Item>Marketing</List.Item>
        <List.Item>What are your data protection rights?</List.Item>
        <List.Item>What are cookies?</List.Item>
        <List.Item>How do we use cookies?</List.Item>
        <List.Item>What types of cookies do we use?</List.Item>
        <List.Item>How to manage your cookies</List.Item>
        <List.Item>Privacy policies of other websites</List.Item>
        <List.Item>Changes to our privacy policy</List.Item>
        <List.Item>How to contact us</List.Item>
        <List.Item>How to contact the appropriate authorities</List.Item>
      </List.Root>
      ...
      >
        ...
        <List.Item>All words entered into the tracking functionality</List.Item>
        <List.Item>Analytics data of Google Analytics</List.Item>
      </List.Root>
      <Heading as="h2" fontSize="3xl" marginTop="1rem">
      ...
      >
        ...
        <List.Item>Enter data into the application.</List.Item>
      </List.Root>
      <Text as="p" fontSize="xl" marginTop="0.6rem">
      ...
      >
        ...
        <List.Item>Github, through the login</List.Item>
      </List.Root>
      <Heading as="h2" fontSize="3xl" marginTop="1rem">
      ...
      <List.Root
        ...
        marginTop="0.6rem"
      >
        <List.Item>Process your order, manage your account.</List.Item>
        <List.Item>
      ...
      <List.Root
        ...
        marginTop="0.6rem"
      >
        <List.Item>Stripe - for payments and subscriptions</List.Item>
      </List.Root>
      <Text as="p" fontSize="xl" marginTop="0.6rem">
      ...
      <List.Root
        ...
        marginTop="0.6rem"
      >
        <List.Item>at our email: {companyEmail}</List.Item>
        <List.Item>
      ...
      <List.Root
        ...
        marginTop="0.6rem"
      >
        <List.Item>Keeping you signed in</List.Item>
        <List.Item>Understanding how you use our website</List.Item>
      </List.Root>
      <Heading as="h2" fontSize="3xl" marginTop="1rem">
      ...
      <List.Root
        ...
        marginTop="0.6rem"
      >
        <List.Item>Email us at: {companyEmail}</List.Item>
        <List.Item>
      ...
      <List.Root
        ...
        marginTop="0.6rem"
      >
        <List.Item>Email: {companyEmail}</List.Item>
        <List.Item>
