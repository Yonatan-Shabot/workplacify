Create a blog article from the markdown in `docs/blogs/why-companies-hot-desking.md`. The article should be in: `src/pages/blog/why-companies-do-hot-desking/index.tsx`.
